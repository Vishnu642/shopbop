...
export const Section1 = ()=>{
    return(
        <Box>
            <Box className="section1-bg" h='500px' backgroundSize='cover' backgroundRepeat='no-repeat' w='100%' bgImg="https://m.media-amazon.com/images/G/01/Shopbop/p/pcs/shopbop/media/desktop/lookbooks/2022/2022_06/sb_20220613_desktop_LB_beachshop_10_1-0.jpg" >
                <Link to="/womens" ><button   className="section1-button" >Shop Now</button></Link>
            </Box>
